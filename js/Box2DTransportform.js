...
function Box2Dbasket ( x,  y) {
    ...
    this.fixDef3.restitution = 1.05;
    this.fixDef3.shape = new b2PolygonShape;
    this.points3 = [{x: 1.5, y: -0.8}, {x: 3, y: -0.7}, {x: 3, y: 1}, {x: -3, y: 1}, {x: -3, y: -0.7}, {x: -1.5, y: -0.8}];
